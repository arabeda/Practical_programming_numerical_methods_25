...
public partial class matrix
{
    ...
    /// <summary>
    /// Indexer for column as a vector.
    /// </summary>
    ...
    /// <summary>
    /// Parse a matrix from a string, e.g. "1 2; 3 4"
    /// </summary>
    ...
    /// <summary>
    /// Matrix-vector "row" multiplication (A^T * v).
    /// </summary>
    public static vector operator %(matrix a, vector v)
    {
    ...
    /// <summary>
    /// Add scaled outer product to matrix: this += s * u * v^T
    /// </summary>
    ...
    {
        vector col = new vector(this.size1);
    ...
    /// </summary>
    public void set_col(int j, vector col)
    {
        for (int i = 0; i < this.size1; i++)
            this[i, j] = col[i];
    }

    // --- Copy, transpose, submatrix ---
    ...
    public matrix T { get { return this.transpose(); } set { } }
    ...
    // --- Approximate equality (elementwise) ---
